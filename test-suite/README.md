...
- [`tabular.test.json`](./tabular.test.json) tests related to determining whether an array contains tabular data and collecting the fields (the table columns) from an array with tabular data.
