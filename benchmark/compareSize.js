...
const example1 = JSON.parse(String(readFileSync(dirname + '/../data/example1.json')))
compareSize(example1)

console.log()
console.log('made up example with many columns and nesting')
const example2 = JSON.parse(String(readFileSync(dirname + '/../data/example2.json')))
compareSize(example2)

{
  const data = JSON.parse(String(readFileSync(dirname + '/../data/unece_country_overview.json')))
  console.log()
  console.log(
...
{
  const data = JSON.parse(String(readFileSync(dirname + '/../data/Biodiversity_by_County.json')))
  console.log()
